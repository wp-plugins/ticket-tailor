...
Tags: ticketing system, sell tickets, event ticketing, ticket, event registration, event management, event, events, ticketing, tickets, ticket shop, e-tickets, box office, e-commerce, paypal, stripe, events, eventbrite, open, woo, conference registration, booking system
...
your event, and best of all there no per-ticket fees.

The Ticket Tailor WordPress plugin allows you to embed your box office pages
...
* No per-ticket fees
* Collect credit/debit card payments using PayPal or Stripe and get paid directly
* Order management tools
* Automatically sends e-tickets to your attendees
* Easily export a doorlist for your event
* Barcode scanning entry system
* Export your customer data
* Website, WordPress and Facebook integration
